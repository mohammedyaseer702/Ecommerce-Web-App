...
import com.example.demo.dto.CartSyncRequest;
...
public class CartController {
    ...
    @PostMapping("/sync")
public String syncCart(@RequestBody CartSyncRequest request,
                       Principal principal) {

    String email = principal.getName();

    for (CartItemRequest item : request.getItems()) {
        cartService.addToCart(email, item.getProductId(), item.getQuantity());
    }
